...
// Append the document to the current document body
...
(function() {
  ...
  function openPopup() {
    // setTimeout(function() {
        ...
        // Remove the appended HTML content and style only if they exist
  ...
  function popupCloseHandler() {
    popupMainBox.style.display = 'none';
    setCookie('popupClosed', 'true', 1); // Expires in 1 day
  }
  ...
  function submitFormHandler(event) {
    ...
    setCookie('popupSubmitted', 'true', 1); // Expires in 1 day
    popupMainBox.style.display = 'none';
  }
